...
const allowedLabels = ["red", "peach", "yellow", "green", "blue", "mauve", "lavender"] as const;
export const colorThemes: typeof allowedLabels[number][] = allowedLabels.filter(label => label in labels);

export const themes = ["light-red", "light-peach", "light-yellow", "light-green", "light-blue", "light-mauve", "light-lavender", "dark-red", "dark-peach", "dark-yellow", "dark-green", "dark-blue", "dark-mauve", "dark-lavender"] as const;
